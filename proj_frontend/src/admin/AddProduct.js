...
function AddProduct() {
    ...
    const {name,description,price,photo,stock,
           categories,category,loading,
           error,createdProduct,getRedirect,
           formData
    } = values;
    ...
    const successMessage = () =>(
        <div className="alert alert-success mt-3" style={{display : createdProduct ? "": "none"}}>
            <h4>{createdProduct} createdProduct successfuly</h4>
        </div>
    )
    ...
    return (
        ...
        descripation="Welcome to product creation section"
